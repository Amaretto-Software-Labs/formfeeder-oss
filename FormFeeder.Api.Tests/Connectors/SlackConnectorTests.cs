...
public class SlackConnectorTests : TestBase
{
    ...
    private readonly Mock<ILogger<SlackConnector>> loggerMock;
    ...
    {
        loggerMock = CreateMock<ILogger<SlackConnector>>();
        httpClientFactoryMock = CreateMock<IHttpClientFactory>();
        httpMessageHandlerMock = CreateMock<HttpMessageHandler>();
        ...
        retryPolicyFactoryMock.Setup(x => x.CreateSlackRetryPolicy())
    ...
    public class Properties : SlackConnectorTests
    {
        ...
        {
            // Arrange
            var defaultConnector = new SlackConnector(loggerMock.Object, httpClientFactoryMock.Object, retryPolicyFactoryMock.Object);
    ...
    public class ExecuteAsync : SlackConnectorTests
    {
        ...
        public async Task ExecuteAsync_ShouldSendCorrectHttpRequest()
        {
            ...
            // Act
            await connector.ExecuteAsync(submission, config);
